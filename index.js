...
module.exports = class SynapsClient {
    ...
    constructor(sessionID, service) {
        ...
        this.callbacks = {};
        this.isOpen = false;
        this.styles = '.sdk-synaps-loader-modal{position:fixed;left:0;top:0;width:100%;height:100%;z-index:9999}.sdk-synaps-loader-embed{position:relative;left:0;top:0;width:100%;height:100%;z-index:9999}.sdk-synaps-loader-logo{background-image:url(https://storage.googleapis.com/synaps-static-assets/white-loader.svg),url(https://storage.googleapis.com/synaps-static-assets/synaps-logo-white.svg);background-size:75px,25px;background-repeat:no-repeat,no-repeat;background-position:center center,center center;background-color:rgb(0 0 0 / 50%)}.sdk-synaps-container{width:100%;height:100%;border-color:transparent;border-width:0;border-style:none;left:0;top:0;-webkit-tap-highlight-color:transparent}@media(max-width:700px){.sdk-synaps-container{width:98%}}';
        this._initStyle();
    }
    ...
    init(options) {
        if (options !== null && options !== void 0 && options.type && !['modal', 'embed'].includes(options.type)) throw new Error('The type must be either "modal" or "embed".');
        this.elementID = options === null || options === void 0 ? void 0 : options.element_id;
        this.colors = (options === null || options === void 0 ? void 0 : options.colors) || {};
        this.type = (options === null || options === void 0 ? void 0 : options.type) || 'modal';
        this.lang = (options === null || options === void 0 ? void 0 : options.lang) || 'en';
    ...
    _formatURL() {
        let url = `${this.baseURL}?session_id=${this.sessionID}&service=${this.service}&type=${this.type}&lang=${this.lang || 'en'}`;
    ...
    _initModal() {
        document.addEventListener('click', ({
            ...
            if (['button', 'a'].includes(element.tagName.toLowerCase()) && ((_element$attributes$i = element.attributes.id) === null || _element$attributes$i === void 0 ? void 0 : _element$attributes$i.value) === this.elementID && !this.isOpen) this.openSession();
        });
    }
    /**
    ...
    _initEmbed() {
        ...
        this.loader.setAttribute('class', 'sdk-synaps-loader-embed sdk-synaps-loader-logo');
    ...
    openSession() {
        ...
        this.loader.setAttribute('class', 'sdk-synaps-loader-modal sdk-synaps-loader-logo');
        this.loaderElement.appendChild(this.loader);
    ...
    getFlow() {
        ...
        this.iframe.setAttribute('border', '0');
        this.iframe.setAttribute('resize', 'none');
        this.iframe.setAttribute('style', 'height:0px;width:0px;position:absolute;');
        return this.iframe;
    }
    /**
